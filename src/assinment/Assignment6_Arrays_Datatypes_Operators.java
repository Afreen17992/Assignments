...
System.out.println(StudentName[0]+" : " + (StudentUpdatedMarks[0]));
System.out.println(StudentName[1]+" : " + (StudentUpdatedMarks[1]));
System.out.println(StudentName[2]+" : " + (StudentUpdatedMarks[2]));
